    ...
    \begin{solution}
        \begin{itemize}
            \item Wir können auf die folgende Attribute mit dem Objekt \code{obj} zugreifen:
                  \begin{itemize}
                      \item Die Attribute \code{f}, \code{by}, \code{i} und \code{d} können vom Objekt \code{obj} zugegriffen werden.
                  \end{itemize}
            \item Wir können die folgenden Methoden mit dem Objekt \code{obj} aufrufen:
                  \begin{itemize}
                      \item \code{m1}: Sie  gibt den Wert \code{-1} zurück.
...
\begin{task}[credit = \stars{2}{3}]{Statischer und dynamischer Typ}
    ...
    \begin{enumerate}[label = (\arabic*)]
        \item Welchen statischen und dynamischen Typ haben \code{a}, \code{b} und \code{g} nach Zeile 40?
        \item Welchen statischen und dynamischen Typ hat \code{a} und welchen Wert hat \code{a.v} nach Zeile 41?
        \item Welchen Wert haben \code{t} und \code{b.v} nach Zeile 42?
        \item Welchen statischen und dynamischen Typ haben \code{a}, \code{b} und welchen Wert hat \code{a.v} nach Zeile 44?
        \item Welchen Wert haben \code{r} und \code{b.v} nach Zeile 45?
    \end{enumerate}
    ...
    \begin{solution}
        \begin{enumerate}[label = (\arabic*)]
            ...
            \item Welchen statischen und dynamischen Typ haben \code{a}, \code{b} und welchen Wert hat \code{a.v} nach Zeile 44?
                  \begin{itemize}
                      \item Der statische Typ von \code{a} ist \code{Alpha} und der dynamische Typ \code{Beta}.
                      \item Der statische Typ von \code{b} ist \code{Beta} und der dynamische Typ \code{Gamma}.
